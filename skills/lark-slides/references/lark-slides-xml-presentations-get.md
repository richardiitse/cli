...
```bash
lark-cli slides xml_presentations get --params '{"xml_presentation_id":"slides_example_presentation_id"}'
```
...
```bash
lark-cli slides xml_presentations get --params '{"xml_presentation_id":"slides_example_presentation_id"}' > presentation_data.json
```
